...
│   ├── lib/                     — GSAP init, constants, lenis-store
...
```
CAL_USERNAME — Your Cal.com username (the part after cal.com/).
               Not a secret — safe to hardcode in SchedulerModal.tsx,
...
- SCHEDULING: Contact form replaced with Cal.com embed modal. EmailJS and
  /api/contact route removed entirely. Scheduling is handled client-side via
  @calcom/embed-react. Google Meet links are generated automatically by Cal.com.
